...
const texts = ["COMPUTER SCIENCE STUDENT", "JUNIOR DEVELOPER", "IT SPECIALIST"];
      ...
      <div class="flex flex-row mb-13 gap-4">
        ...
        <div class="flex-col ml-10">
          ...
          <div className="myIntro">
            ...
            <Typewriter options={{
              strings: "Welcome to my website!<br/> I am a CS student based in San Jose, California.<br/><br/> I've always been fascinated with how far technology has evolved throughout the years: from <i><a href=\"https://www.maa.org/press/periodicals/convergence/mathematical-treasure-ishango-bone\">Ishango bones</a></i> to NoSQL, from the first ever autonomous chess machine: <i><a href=\"https://www.chessprogramming.org/El_Ajedrecista\">El Ajedrecista<a></i> to AlphaZero. ",
              autoStart: true,
              delay: 5,
              loop: false,
            }}/>
